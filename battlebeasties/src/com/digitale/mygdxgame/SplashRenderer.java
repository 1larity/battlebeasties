...
public class SplashRenderer {
			...
			renderInsideStation(app); 
			  ...
			  if(BattleBeasties3d.manager.update()) {
			      ...
			      // display loading information
			       ...
			       if(BattleBeasties3d.manager.isLoaded("sound/movement_proposition.mp3")&& musicPlaying==false) {
			    	   // music is available, let's play it 
			    	   musicPlaying=true;
			    	   SoundManager.music = BattleBeasties3d.manager.get("sound/movement_proposition.mp3", Music.class);
	...
	private void bindTextures() {
		...
		BattleBeasties3d.manager.get("data/planet02.jpg", Texture.class).setFilter(TextureFilter.Linear, TextureFilter.Linear);
		planetTexture = BattleBeasties3d.manager.get("data/planet02.jpg", Texture.class);
		BattleBeasties3d.manager.get("data/sky01.jpg", Texture.class).setFilter(TextureFilter.Linear, TextureFilter.Linear);
		skyTexture = BattleBeasties3d.manager.get("data/sky01.jpg", Texture.class);
		BattleBeasties3d.manager.get("data/destroyer01.png", Texture.class).setFilter(TextureFilter.Linear, TextureFilter.Linear);
		shipTexture = BattleBeasties3d.manager.get("data/destroyer01.png", Texture.class);
		
		xfadeTexture = BattleBeasties3d.manager.get("data/blackpixel.png", Texture.class);
		BattleBeasties3d.manager.get("data/nova.png", Texture.class).setFilter(TextureFilter.Linear, TextureFilter.Linear);
		sunTexture = BattleBeasties3d.manager.get("data/nova.png", Texture.class);
		BattleBeasties3d.manager.get("data/jet.png", Texture.class).setFilter(TextureFilter.Linear, TextureFilter.Linear);
