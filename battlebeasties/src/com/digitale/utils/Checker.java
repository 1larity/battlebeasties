...
public class Checker {
    ...
    public static void CheckEncryption() throws Exception {
        ...
        if(BattleBeasties3d.DEBUG)System.out.println("Plain Text : " + password);
        if(BattleBeasties3d.DEBUG)System.out.println("Encrypted Text : " + encrypted);
        if(BattleBeasties3d.DEBUG)System.out.println("Decrypted Text : " + decrypted);
        decrypted = new String( mcrypt.decrypt( "a9e88a3511dfa65627ab49a1af32be07104dece4e4b53421" ) );
        if(BattleBeasties3d.DEBUG)System.out.println("quick decrypt "+decrypted);
    }
}
