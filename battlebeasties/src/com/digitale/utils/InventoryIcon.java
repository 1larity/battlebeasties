...
public class InventoryIcon {
	...
	static Pixmap imgZero = (BattleBeasties3d.manager.get("data/0.png", Pixmap.class));
	static Pixmap imgOne = (BattleBeasties3d.manager.get("data/1.png", Pixmap.class));
	static Pixmap imgTwo = (BattleBeasties3d.manager.get("data/2.png", Pixmap.class));
	static Pixmap imgThree =(BattleBeasties3d.manager.get("data/3.png", Pixmap.class));
	static Pixmap imgFour = (BattleBeasties3d.manager.get("data/4.png", Pixmap.class));
	static Pixmap imgFive = (BattleBeasties3d.manager.get("data/5.png", Pixmap.class));
	static Pixmap imgSix = (BattleBeasties3d.manager.get("data/6.png", Pixmap.class));
	static Pixmap imgSeven = (BattleBeasties3d.manager.get("data/7.png", Pixmap.class));
	static Pixmap imgEight = (BattleBeasties3d.manager.get("data/8.png", Pixmap.class));
	static Pixmap imgNine = (BattleBeasties3d.manager.get("data/9.png", Pixmap.class));
	...
	public static Texture generateDynamicTexture(String iconFilename, String category,
		...
		Pixmap imgB =(BattleBeasties3d.manager.get(iconFilename, Pixmap.class));
