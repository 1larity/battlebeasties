			...
			public void click(Actor actor, float x, float y) {
				...
				if (checkEmail(memail.toLowerCase())){
					if (checkuser(ac)){
					 ...
					 BattleBeasties3d.MyDataOp.getFreeUser(ac);
							if (BattleBeasties3d.muserExists.equals("0")){
								
								SoundManager.playconfirm();
								   if(BattleBeasties3d.DEBUG) System.out.println(LOG_TAG+ " " + mpw1);
							     	
								 stage.addActor(Actors.bottomToast("Your account has been created, please check your EMail.",
											4, skin));
								BattleBeasties3d.MyDataOp.createUser(ac,mpw1,memail);
