...
public class Splash extends StardustScreen{
	...
	public Splash() {
		...
		timer.scheduleAtFixedRate(new TimerTask() {
			public void run() { 
				...
				if (i %10==0 && loadstate==(int) i/10 && BattleBeasties3d.Error==BattleBeasties3d.ALL_OK){
					if(BattleBeasties3d.DEBUG) System.out.println("loading stage "+(int) i/10);
			incrementalloader((int) i/10);
				...
				if(BattleBeasties3d.DEBUG) System.out.println("timer "+i%10+"  div"+(int) i/10+ " loadstate "+loadstate );
				}	
		}, 0, 100);
	...
	public boolean isDone() {
		if (i>100 && BattleBeasties3d.manager.update()){
			timer.cancel();
			BattleBeasties3d.gameMode=2;
			return true;
...
private void incrementalloader(int time){
	...
	case 1:
		//load some stuff
		BattleBeasties3d.loadstage01();
		//increment loaded flag
		loadstate=2;
		break;
	case 2:
	//load some stuff
		BattleBeasties3d.loadstage02();
			//increment loaded flag
	loadstate=3;
			break;
	case 3:
	//load some stuff
		BattleBeasties3d.loadstage03();
			//increment loaded flag
	loadstate=4;
			break;
	case 4:
	//load some stuff
		BattleBeasties3d.loadstage04();
	//increment loaded flag
	loadstate=5;
			break;
	...
	case 5:
	//load some stuff
		BattleBeasties3d.loadstage05();
		//increment loaded flag
		loadstate=6;
				break;
	case 6:
	//load some stuff
		BattleBeasties3d.loadstage06();
		//increment loaded flag
		loadstate=7;
				break;
	case 7:
	//load some stuff
		BattleBeasties3d.loadstage07();
		//increment loaded flag
		loadstate=8;
				break;
	case 8:
	//load some stuff
		BattleBeasties3d.loadstage08();
		//increment loaded flag
		loadstate=9;
				break;
	case 9:
	//load some stuff
		BattleBeasties3d.loadstage09();
		//increment loaded flag
		loadstate=10;
				break;
	case 10:
	//load some stuff
		BattleBeasties3d.loadstage10();
		//increment loaded flag
		loadstate=11;
				break;
	}
