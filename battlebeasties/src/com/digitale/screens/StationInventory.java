...
public class StationInventory extends StardustScreen {
	...
	public StationInventory(Stage stage) {
		...
		final Label balance = new Label(BattleBeasties3d.myCharacter.getCredits()
		...
		buttonClose.setClickListener(new ClickListener() {
			...
			public void click(Actor actor, float x, float y) {
				...
				BattleBeasties3d.MyDataOp.getInventory(Integer
						.valueOf(BattleBeasties3d.currencharacteruid),false);	
				BattleBeasties3d.stationScreen = 102;
		...
		buttonAllToWarehouse.setClickListener(new ClickListener() {
			...
			public void click(Actor actor, float x, float y) {
				...
				SoundManager.playuiclick();
				BattleBeasties3d.MyDataOp.newRequest("movealltowarehouse#");

				for (int i = 0; i < BattleBeasties3d.myInventory.size(); i++) {
					Inventory item = BattleBeasties3d.myInventory.get(i);
	...
	private Table initGridWarehouse() {
		...
		for (int x = 0; x < BattleBeasties3d.myInventory.size(); x++) {
			...
			if (item.getSlot_id() == 1) {
				if (item.getInventoryid() == BattleBeasties3d.myCharacter
						.getShipid()){
					iscurrentship=true;
				}else{
					iscurrentship=false;
