...
public class Char extends StardustScreen {
	...
	public Char(Stage stage) {
		...
		// Group.debug = true;
		final Label nameLabel = new Label(BattleBeasties3d.myCharacter.getFirstname()
				 + BattleBeasties3d.myCharacter.getSurname(),
		...
		selectedCharacter = ("Character: "
				+ BattleBeasties3d.charList[0].getFirstname() + " " + BattleBeasties3d.charList[0]
				.getSurname());
		...
		buttonClose.setClickListener(new ClickListener() {
			...
			public void click(Actor actor, float x, float y) {
				...
				SoundManager.playuiclick();
				BattleBeasties3d.stationScreen = 105;
				doneflag = true;
			}
		});
	}
